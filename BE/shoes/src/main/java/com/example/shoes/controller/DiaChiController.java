...
public class DiaChiController
{
    ...
    @PostMapping("/add")
    public ApiResponse<DiaChiResponse> add(@Valid @RequestBody CreateDiaChiRequest request, BindingResult bindingResult)
    {
    ...
    public ApiResponse<DiaChi> addByIdKhachHang(@PathVariable("id") Integer id,
          @Valid  @RequestBody CreateDiaChiRequest request,BindingResult bindingResult)
    {
        if (bindingResult.hasErrors()) {
            throw new ValidationException(bindingResult.getFieldError().getDefaultMessage());
        }
    ...
    @PostMapping("/update")
    public ApiResponse<DiaChiResponse> update(@Valid @RequestBody UpdateDiaChiRequest request,
