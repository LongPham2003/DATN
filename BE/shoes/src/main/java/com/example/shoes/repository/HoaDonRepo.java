...
public interface HoaDonRepo extends JpaRepository<HoaDon, Integer> {
        ...
        List<Object[]> layBaoCaoTaiChinhTheoNgay(@Param("startDate") LocalDate startDate,
        ...
        List<Object[]> layBaoCaoTaiChinhTheoThang(@Param("startDate") LocalDate startDate,
                        @Param("endDate") LocalDate endDate);
        ...
        List<Object[]> layBaoCaoTaiChinhTheoNam(@Param("startDate") LocalDate startDate,
                        @Param("endDate") LocalDate endDate);
        ...
        @Query(value = "select  hd.id ,hd.create_at,hd.create_by,hd.update_at,hd.update_by ,hd.dia_chi_giao_hang ,hd.phi_van_chuyen, "
                        +
                        "hd.ma,hd.ngay_sua ,hd.ngay_tao ,hd.phuong_thuc_giao_hang , hd.phuong_thuc_thanh_toan , hd.so_dien_thoai,hd.ngay_du_kien ,"
                        +
