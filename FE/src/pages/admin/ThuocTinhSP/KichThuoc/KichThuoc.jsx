    ...
    <>
      <div className="w-full h-screen overflow-auto">
        <div className="mb-4 p-4 bg-white rounded shadow">
          <h2 className="text-xl font-bold mb-2">Thêm Kích Thước Mới</h2>
          <form className="flex flex-wrap -mx-2">
            <div className="w-1/2 px-2 mb-4">
              <label htmlFor="maKichThuoc" className="block mb-1">Mã Kích Thước:</label>
              <input
                type="text"
                id="maKichThuoc"
            ...
            <div className="w-1/2 px-2 mb-4">
              <label htmlFor="tenKichThuoc" className="block mb-1">Tên Kích Thước:</label>
              <input
                type="text"
                id="tenKichThuoc"
                className="w-full p-2 border rounded"
