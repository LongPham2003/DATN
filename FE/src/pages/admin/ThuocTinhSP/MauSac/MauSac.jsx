    ...
    <>
      <div className="w-full h-screen overflow-auto">
        <div className="mb-4 p-4 bg-white rounded shadow">
          <h2 className="text-xl font-bold mb-2">Thêm Màu Sắc Mới</h2>
          <form className="flex flex-wrap -mx-2">
            <div className="w-1/2 px-2 mb-4">
              <label htmlFor="maMauSac" className="block mb-1">Mã Màu Sắc:</label>
              <input
                type="text"
                id="maMauSac"
            ...
            <div className="w-1/2 px-2 mb-4">
              <label htmlFor="tenMauSac" className="block mb-1">Tên Màu Sắc:</label>
              <input
                type="text"
                id="tenMauSac"
                className="w-full p-2 border rounded"
